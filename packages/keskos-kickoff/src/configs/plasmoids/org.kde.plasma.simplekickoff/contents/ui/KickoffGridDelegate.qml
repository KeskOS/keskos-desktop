...
AbstractKickoffItemDelegate {
    ...
    background: Item {
        Rectangle {
            anchors.fill: parent
            anchors.margins: 6
            color: root.currentItemSelected ? keskStyle.selectedFillColor : (mouseArea.containsMouse ? keskStyle.hoverFillColor : "transparent")
            border.width: root.currentItemSelected ? 1 : (mouseArea.containsMouse ? 1 : 0)
    ...
    contentItem: ColumnLayout {
        ...
        PC3.Label {
            ...
            maximumLineCount: 2
            wrapMode: Text.Wrap
            color: root.currentItemSelected ? keskStyle.accentColor : keskStyle.textColor
