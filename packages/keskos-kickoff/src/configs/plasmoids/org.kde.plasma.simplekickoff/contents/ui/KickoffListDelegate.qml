...
AbstractKickoffItemDelegate {
    ...
    contentItem: RowLayout {
        id: row
        spacing: KickoffSingleton.listItemMetrics.margins.left + Kirigami.Units.smallSpacing
        ...
        GridLayout {
            ...
            readonly property color textColor: root.currentItemSelected ? keskStyle.accentColor : (root.isCategoryListItem ? keskStyle.textColor : keskStyle.textColor)
            ...
            PC3.Label {
                ...
                font.pixelSize: root.isCategoryListItem ? 17 : 14
            }
