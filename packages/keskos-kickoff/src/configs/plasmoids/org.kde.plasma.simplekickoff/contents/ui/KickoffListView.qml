    ...
    contentItem: ListView {
        ...
        section {
            ...
            delegate: PC3.AbstractButton {
                ...
                PC3.Label {
                    ...
                    color: hoverHandler.hovered ? keskStyle.accentColor : keskStyle.textMutedColor
        ...
        PC3.ScrollBar.vertical: PC3.ScrollBar {
            ...
            background: Rectangle {
                ...
                border.width: 1
                border.color: Qt.rgba(206 / 255, 106 / 255, 53 / 255, 0.18)
                radius: 1
            }
            contentItem: Rectangle {
                implicitWidth: 6
                radius: 1
                color: verticalScrollBar.pressed || verticalScrollBar.hovered ? keskStyle.accentColor : keskStyle.textMutedColor
                border.width: 1
                border.color: verticalScrollBar.pressed || verticalScrollBar.hovered ? keskStyle.accentBrightColor : keskStyle.borderColor
            }
        }
