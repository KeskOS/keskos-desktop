...
RowLayout {
    ...
    RowLayout {
        ...
        Repeater {
            ...
            delegate: PC3.ToolButton {
                ...
                icon.color: hovered ? keskStyle.accentColor : keskStyle.textMutedColor
                ...
                background: Rectangle {
                    color: parent.hovered || parent.down ? keskStyle.selectedFillColor : keskStyle.panelAltColor
                    border.width: 1
                    border.color: parent.hovered || parent.down ? keskStyle.accentBrightColor : keskStyle.borderColor
    ...
    PC3.ToolButton {
        ...
        icon.color: hovered || down ? keskStyle.accentColor : keskStyle.textMutedColor
        ...
        implicitHeight: Kirigami.Units.gridUnit * 1.9
        background: Rectangle {
            color: leaveButton.hovered || leaveButton.down ? keskStyle.selectedFillColor : keskStyle.panelAltColor
            border.width: 1
            border.color: leaveButton.hovered || leaveButton.down ? keskStyle.accentBrightColor : keskStyle.borderColor
            radius: keskStyle.panelCornerRadius
        }
