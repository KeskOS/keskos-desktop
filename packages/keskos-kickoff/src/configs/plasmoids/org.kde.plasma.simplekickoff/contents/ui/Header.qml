...
EmptyPage {
    ...
    contentHeight: Math.max(searchField.implicitHeight, leaveButtons.implicitHeight) + 4
    ...
    RowLayout {
        ...
        PlasmaExtras.SearchField {
            ...
            font.pixelSize: 16
            color: keskStyle.textColor
            selectionColor: keskStyle.accentDimColor
            selectedTextColor: keskStyle.accentColor
            background: Rectangle {
                color: kickoff.searchField && kickoff.searchField.activeFocus ? keskStyle.panelAltColor : keskStyle.panelColor
                border.width: 1
                border.color: kickoff.searchField && kickoff.searchField.activeFocus ? keskStyle.accentBrightColor : keskStyle.borderColor
                radius: keskStyle.searchCornerRadius
                ...
                Rectangle {
                    ...
                    color: "transparent"
                    border.width: 1
                    border.color: kickoff.searchField && kickoff.searchField.activeFocus ? keskStyle.innerBorderColor : Qt.rgba(1, 1, 1, 0.05)
                    radius: keskStyle.searchCornerRadius
                }
            }
        ...
        PC3.ToolButton {
            ...
            icon.color: hovered || checked ? keskStyle.accentColor : keskStyle.textMutedColor
            background: Rectangle {
                color: pinButton.checked || pinButton.hovered ? keskStyle.selectedFillColor : keskStyle.panelAltColor
                border.width: 1
                border.color: pinButton.checked || pinButton.hovered ? keskStyle.accentBrightColor : keskStyle.borderColor
